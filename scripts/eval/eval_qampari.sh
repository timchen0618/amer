...
# file_list="retrieval_out_dev_qampari_query_exp_5_to_8_max_new_tokens_1.jsonl"  # retrieval_out_dev_qampari_5_to_8_max_new_tokens_1.jsonl
...
do
    ...
    # ROOT_DIR="/scratch/hc3337/projects/autoregressive/results/base_retrievers/contriever/"
    echo "Evaluating retrieval results for $retriever"
    python eval.py --data-type $data_name \
        --root $ROOT_DIR \
