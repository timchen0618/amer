...
for data_name in "arguana_generated"
do
    training_data_name="qampari"
    suffix_list="normalized_qampari_4gpu_full_finetuning_SSVariableLeftPad_hungarian_contrastive_lr2e-5_temp0.05_batch32_ep120_warmup0.05"
    ...
    do
        ...
        for DATA in  "retrieval_out_dev_${data_name}.jsonl.mistralpred" 
        do
            MODEL_SHORT="mistral"
