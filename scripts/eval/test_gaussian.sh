...
# echo "================================================================"
# # MLP, large
# python test.py --model_paths  results/llama-1b/gaussian_diverse_mlps_inf/normalized_large_mlps_gaussian_full_finetuning_SS_contrastive_all_labels_shuffled_lr5e-5_temp0.05_batch128_ep3000_warmup0.05/  --checkpoint_name best_model -n 1 5  --split test --k_values 1 5 10 20 50 100 500 --model_type EmbeddingModelSS --embedding_model_dim 1024 -d data_creation/gaussian/data/diverse_mlps_large/ --full_finetuning 
