...
python test.py \
--model_paths  ${results_dir}/orca_gaussian_full_finetuning_hungarian_contrastive_lr2e-5_temp0.05_batch16_ep100_warmup0.05/ ${results_dir}/orca_gaussian_full_finetuning_contrastive_all_labels_ordered_lr2e-5_temp0.05_batch16_ep100_warmup0.05/ ${results_dir}/orca_gaussian_full_finetuning_mse_all_labels_lr2e-5_temp0.05_batch16_ep100_warmup0.05/ ${results_dir}/orca_gaussian_full_finetuning_contrastive_all_labels_shuffled_lr2e-5_temp0.05_batch16_ep100_warmup0.05/  --checkpoint_name best_model -n 1 5  --split test --k_values 10 20 50 100 500 --model_type EmbeddingModel --embedding_model_dim 1024 -d data_creation/gaussian/data/opposing_pairs_data_large/ --full_finetuning 