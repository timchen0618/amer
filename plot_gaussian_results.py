...
FIGURE_WIDTH = 16
FIGURE_HEIGHT = 5  # Reduced from 8 for better aspect ratio
...
# Each section has Single and Multi-Query for both MRecall@100 and MRecall@10
...
ax.set_ylabel('Performance Score', fontweight='bold', fontsize=18)  # Increased from 12
...
ax.legend(frameon=True, fancybox=True, shadow=True, loc='upper left', fontsize=14)  # Increased from 11

# Add grid for better readability
ax.grid(True, alpha=0.3, axis='y', linestyle='--')
ax.set_ylim(0, 119)  # Increased to accommodate larger section labels
...
ax.text(1.5, 113, 'Gaussian', ha='center', fontweight='bold', fontsize=18,  # Increased from 14
        bbox=dict(boxstyle="round,pad=0.5", facecolor="lightblue", alpha=0.9, edgecolor='navy', linewidth=2))
ax.text(5.5, 113, 'Multi', ha='center', fontweight='bold', fontsize=18,  # Increased from 14
        bbox=dict(boxstyle="round,pad=0.5", facecolor="lightgreen", alpha=0.9, edgecolor='darkgreen', linewidth=2))
ax.text(9.5, 113, 'OOD', ha='center', fontweight='bold', fontsize=18,  # Increased from 14
...
ax.text(0.5, -17, 'Single-Query', ha='center', fontsize=17, fontweight='bold')  # Increased from 10
ax.text(2.5, -17, 'Multi-Query', ha='center', fontsize=17, fontweight='bold')
ax.text(4.5, -17, 'Single-Query', ha='center', fontsize=17, fontweight='bold')
ax.text(6.5, -17, 'Multi-Query', ha='center', fontsize=17, fontweight='bold')
ax.text(8.5, -17, 'Single-Query', ha='center', fontsize=17, fontweight='bold')
ax.text(10.5, -17, 'Multi-Query', ha='center', fontsize=17, fontweight='bold')
