...
elif [[ "$data_name" == "ambigqa_single" ]]; then
    dev_data_path="data/questions/ambigqa_dev_single_answer_question_only.jsonl"
...
elif [[ "$data_name" == "ambiguous_qe_mmlf" ]]; then
    dev_data_path="data/mmlf/ambiguous_qe_passages.jsonl"
elif [[ "$data_name" == "qampari_mmlf" ]]; then
    dev_data_path="data/mmlf/qampari_passages.jsonl"
else
