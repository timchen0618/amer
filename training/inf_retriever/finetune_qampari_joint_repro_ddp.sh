...
#SBATCH --time=2:45:00
#SBATCH --mem=128GB
#SBATCH --job-name=qampari_joint_repro_ddp
#SBATCH --output=sbatch_outputs/qampari_joint_repro_ddp.out
...
run_name=qampari_joint_repro_with_detach_steps5000_t0.05_lr0.00001_ws200_bs50_hungarian_ddp

accelerate launch --config_file training/inf_retriever/accelerate_config_2gpu_ddp.yaml --main_process_port 29521 training/inf_retriever/finetuning_multi.py \
