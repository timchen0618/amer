...
accelerate launch --config_file training/inf_retriever/accelerate_config_2gpu_ddp.yaml --main_process_port 29501 training/inf_retriever/finetuning_multi.py \
