...
if __name__ == '__main__':
    ...
    if args.command == 'randomness':
        ...
        all_scores = []
        folder_list = [
                       'large_mlps_gaussian_full_finetuning_SS_hungarian_contrastive_lr2e-5_temp0.05_batch512_ep1000_warmup0.05/',
                       'large_mlps_gaussian_full_finetuning_SS_contrastive_all_labels_ordered_lr2e-5_temp0.05_batch512_ep1000_warmup0.05',
                    #    'linear_gaussian_sample_transformation_full_finetuning_SS_contrastive_first_label_lr2e-5_temp0.05_batch32_ep400_warmup0.05'
                       ]
        for folder in folder_list:
            ### Get results
            model_path = Path(args.rootdir) / folder
