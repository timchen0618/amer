...
# Add legend with larger font (moved down slightly)
ax.legend(frameon=True, fancybox=True, shadow=True, loc='upper left', 
          bbox_to_anchor=(0, 0.85), fontsize=17)  # Moved down from top
...
ax.text(1.5, 116, 'Single-in-distribution', ha='center', fontweight='bold', fontsize=18,  # Increased from 14
        bbox=dict(boxstyle="round,pad=0.5", facecolor="lightblue", alpha=0.9, edgecolor='navy', linewidth=2))
ax.text(5.5, 116, 'Multi-in-distribution', ha='center', fontweight='bold', fontsize=18,  # Increased from 14
