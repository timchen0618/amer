            ...
            for max_new_tokens in args.max_new_tokens_list:
                with torch.no_grad():
                    ...
                    if args.data_dir == './data_creation/gaussian/data/linear_large/' or args.data_dir == 'data_creation/gaussian/data/linear_large/' or args.data_dir == 'data_creation/gaussian/data/linear_large':
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps_multi_query/inf/gaussian_diverse_mlps_multi_query_{args.split}_dataset_1b_contrastive_sm/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps_multi_query/inf/gaussian_diverse_mlps_multi_query_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps/inf/gaussian_diverse_mlps_{args.split}_dataset_1b_contrastive_sm/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)                    
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps/inf/gaussian_diverse_mlps_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)                    
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps_sample_transformation/inf/gaussian_diverse_mlps_sample_transformation_{args.split}_dataset_1b_contrastive_sm/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps_sample_transformation/inf/gaussian_diverse_mlps_sample_transformation_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_diverse_mlps_ood/inf/gaussian_diverse_mlps_ood_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_linear_multi_query/inf/gaussian_linear_multi_query_{args.split}_dataset_1b_contrastive_sm/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_linear_multi_query/inf/gaussian_linear_multi_query_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_linear_sample_transformation/inf/gaussian_linear_sample_transformation_{args.split}_dataset_1b_contrastive_sm/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_linear_sample_transformation/inf/gaussian_linear_sample_transformation_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_linear_ood/inf/gaussian_linear_ood_{args.split}_dataset_1b_contrastive_sm/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_linear_ood/inf/gaussian_linear_ood_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_new_mlps/inf/gaussian_new_mlps_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_new_mlps_harder/inf/gaussian_new_mlps_harder_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_new_mlps_normal/inf/gaussian_new_mlps_normal_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                        ...
                        dataloader = load_input_data(f'training_datasets/llama-1b/gaussian_new_mlps_opposite/inf/gaussian_new_mlps_opposite_{args.split}_dataset_1b_contrastive/', use_ground_truth_for_eval=args.use_ground_truth_for_eval)
                    else:
