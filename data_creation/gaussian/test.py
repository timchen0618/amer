...
if command == 'simple_train':
    test_pairs, queries, corpus = load_synthetic_dataset(data_dir='./data/opposing_pairs_data/')
    ...
    split = 'train'
    data_dir = './data/opposing_pairs_data_large/'
    MAX_NEW_TOKENS = 1
    ...
    load_path = 'results/gaussian_synthetic_inf/toy_contrastive_lr2e5_ep20_temp0.05_warmup0.05_gradnorm1_bs16/'
    
    adapter_path = os.path.join(load_path, 'best_model.pt')
    linear_checkpoint_path = os.path.join(load_path, 'best_model_linear.pt')
