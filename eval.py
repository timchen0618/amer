...
def get_data_mapping(project_root):
    ...
    return {
        ...
        "ambiguous_single": {
            'dev': f'{project_root}/autoregressive/data/ambiguous/single_qa/ambigqa_dev_single_answer_with_gt_filtered.jsonl',
        },
        "wsd_distinct": {
...
def parse_arguments():
    ...
    parser.add_argument('--data-type', type=str, default='wsd_distinct',
                       choices=['qampari', 'ambiguous', 'ambiguous_qe', 'wsd_distinct', 'qampari_5_to_8', 'ambiguous_single'],
...
def get_split_for_data_type(data_type):
    ...
    if data_type in ['qampari', 'ambiguous_single']:
        return 'dev'
