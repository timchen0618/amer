...
if [ "$use_inf_base_model" = true ]; then
    ...
    BASE_SAVE_PATH="results/llama-1b/qampari+ambiguous_qe_inf/fixed_model"
fi
...
if [ "$use_inf_base_model" = true ]; then
    ...
    # MODEL_ID="results/llama-1b/gaussian_new_mlps_rotation_inf/normalized_large_new_mlps_gaussian_rotation_pred_length_full_finetuning_SSPredLength_hungarian_contrastive_lr5e-5_temp0.05_batch128_ep1500_warmup0.05_srm1/best_model"
    # BASE_ADAPTER_PATH=None
    # BASE_LINEAR_CHECKPOINT_PATH=None
fi
